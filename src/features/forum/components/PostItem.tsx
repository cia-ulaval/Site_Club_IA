...
export function PostItem({ 
  ...
  const canEdit = currentUserId === post.author_id || currentUserRole === 'admin';
      ...
      <div className="flex">
        ...
        <div className="w-32 sm:w-48 border-r border-gray-200 dark:border-gray-700 p-4">
          <div className="text-center">
            ...
            {/* Role Badge */}
            {post.author?.role && (
              <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getRoleBadgeColor(post.author.role)}`}>
        ...
        <div className="flex-1 p-4">
          ...
          {/* Quote if reply */}
          {post.reply_to && (
            <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-900 border-l-4 border-gray-300 dark:border-gray-600 rounded-r">
