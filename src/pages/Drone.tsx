          ...
          <div>
            <div className="relative mb-20">
              ...
              <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-neutral-500 leading-relaxed">{t('drone.hero.paragraph2')}</p>
                </motion.div>
                <motion.div
                  className="relative"
            ...
            >
              <div className="text-center">
                ...
                <p className="theme-text-secondary font-medium">{t('drone.team.lead')}</p>
              </div>
              <div className="h-12 w-px bg-primary-500/30" />
              <div className="text-center">
                <Lightbulb className="w-8 h-8 theme-text-accent mx-auto mb-2" />
                <p className="theme-text-secondary font-medium">{t('drone.team.partner')}</p>
              </div>
              <div className="h-12 w-px bg-primary-500/30" />
              <div className="text-center">
                <Trophy className="w-8 h-8 theme-text-accent mx-auto mb-2" />
                <p className="text-primary-300 font-bold text-lg">{t('drone.team.size')}</p>
              </div>
            </motion.div>
            <div className="mb-20">
                    ...
                    >
                      ...
                      <div className="relative bg-base/60 backdrop-blur-sm rounded-3xl p-6 h-full">
                        <div className="flex items-start gap-4 mb-4">
                          ...
                          <div>
                            <h3 className="text-xl font-bold text-accent-300 mb-1">{role.title}</h3>
                            <span className="text-primary-300 text-sm font-semibold">
                              {role.count}
                            </span>
                          </div>
                        </div>
                        <p className="theme-text-muted text-sm mb-4">{role.description}</p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-accent-300 mb-2">{t('drone.cta.title')}</h3>
              <p className="theme-text-muted mb-2">{t('drone.cta.subtitle')}</p>
              <p className="text-primary-300 font-semibold mb-8">{t('drone.cta.description')}</p>
              <motion.a
