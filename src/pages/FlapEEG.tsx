  ...
  return (
    <>
      <head>
        ...
        <meta
          name="description"
          content="FlapEEG is a revolutionary video game controlled by thought. Learn how our team trained an AI model to interpret brain signals and make gaming more immersive."
        />
        <meta
          name="keywords"
          content="FlapEEG, thought-controlled game, EEG technology, AI gaming, brain signals, video game innovation"
        />
        <meta name="author" content="Dereck Bélanger and Team" />
          ...
          <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="flex flex-col justify-center mt-6 md:mt-0">
                  ...
                  <p className="text-gray-400 mb-4 sm:mb-6 text-justify">
                    FlapEEG is a video game that is controlled by thought. We
                    have trained an AI model to interpret brain signals and
                    translate them into actions in the game. For this to work,
                    we equipped ourselves with the latest EEG
                    (electroencephalogram) technology and a lot of patience. It
                    was hard at first, we needed to test with simple algorithms,
                    but once we got the hang of it, we introduced our AI model
                    and with trial and error, got it to understand the brain
                    signals. The game is now fully functional and every thought
                    you have counts: that's how you control your character!
                  </p>
                  <p className="text-gray-400 text-justify">
                    ...
                    disabilities by giving them power from their own thoughts?
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    ...
                    would've liked done, but in winter of 2025, we learnt from
                    our experience and came back strong! We approached the
                    project with a new concept: instead of open to everyone, we
                    would screen the participants and make a choice based on
                    their skills, their availability but most importantly, their
                    interest in the project. This way, we were able to work much
                    more efficiently and address any issues immediately. It was
                    indeed a great success! We were able to finish the first
                    step of FlapEEG before our deadline: Make it work with a
                    simple algorithm that would detect blinks. Our member Dereck
                    worked on this and Louis-Étienne helped him fix the bugs.
                    You can see on this preview the first prototype. In the
                    meantime, our other members were working on finishing the
                    game, researching and collecting data.
                  </p>
                </div>
              </div>
              <p className="text-gray-400 mt-4 sm:mt-6">
                It was only a rough prototype, as you can see, some latency was
                still present and the game was not fully functional. But it was
                a step in the right direction which led us to week 2...
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div>
                  <p className="text-gray-400">
                    ...
                    participants to train our AI model to interpret brain
                    signals. We had to find a way to collect this data and to
                    make sure it was clean and usable. To do that, we asked many
                    participants to perform a series of tests with the headset.
                    We then had Jordan and Dereck work on a way to clean the
                    data and make it usable.
                  </p>
                  <p className="text-gray-400 mt-4 sm:mt-6">
                    In the meantime, Louis-Étienne installed a server to
                    centralize our datasets, William finished the game.
                    Everything was slowly coming together, but the hardest part
                    was yet to come!
                  </p>
                </div>
            ...
            <section id="Week4-6" className="mb-12 sm:mb-20">
              ...
              <p className="text-gray-400 pb-3 sm:pb-4">
                At this point in the project, we hit a challenge. Louis found
                out our data wasn't properly filtered and we had a lot of noise
                around the 60Hz frequency which made it unusable. Jordan took
                care of this and found a way to filter out the noise.
              </p>
              <p className="text-gray-400">
                This leads us to the middle of the semester; everyone is
                preparing for the exams so we decided to take the next week or
                two reading scientific papers and sharing our discoveries with
                each other to face the future challenges.
              </p>
            </section>
            ...
            <section id="Week6-9" className="mb-12 sm:mb-20">
              ...
              <p className="text-gray-400">
                ...
                isolate from the intention signals, but after a meeting where
                the whole team shared their ideas, we were able to come up with
                a new optimized protocol that would allow us to train our AI
                model to understand the brain signals and to translate them into
                actions in the game.
              </p>
            </section>
          </div>
