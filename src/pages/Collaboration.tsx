...
const CurrentSponsorLogo = ({ sponsor }: { sponsor: Sponsor }) => (
  <motion.a
    ...
    className="p-3 md:p-6 rounded-xl bg-gradient-to-br from-red-900/30 to-red-800/20 border custom-border-red hover:border-red-500/50 transition-all duration-300 text-center group"
