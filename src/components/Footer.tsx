...
function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-red-300 dark:from-red-950 dark:via-red-900/10 to-white dark:to-dark border-t border-red-500/30 py-12 mt-20 overflow-hidden">
